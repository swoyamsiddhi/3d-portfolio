    ...
    return (
        <section id="projects" className="relative bg-black text-white overflow-hidden rounded-3xl mx-2 my-2">
            ...
            <div ref={triggerRef} className="relative h-screen w-screen">
                ...
                <div ref={sectionRef} className="flex flex-row w-[300vw] h-screen">
                    ...
                    <div className="w-screen h-screen relative flex-shrink-0 flex items-center justify-center p-10 overflow-hidden">
                        ...
                        <div className="absolute right-10 top-1/2 -translate-y-1/2 w-[40vw] h-[80vh] bg-neutral-800 overflow-hidden grayscale hover:grayscale-0 transition-all duration-700 ease-in-out">
                            {/* Project Image */}
                            <div className="w-full h-full bg-[url('/projects/tagore.png')] bg-cover bg-center opacity-60 hover:opacity-100 transition-opacity duration-700"></div>
                        </div>

                        {/* Number 03 */}
                        <div className="absolute bottom-[10vh] right-[35vw] z-20">
                            <span className="font-serif text-[15rem] leading-none text-white mix-blend-overlay opacity-80">03</span>
                        </div>

                        {/* Title (Left Side) */}
                        <div className="absolute top-1/2 left-10 translate-y-[-50%] z-30 mix-blend-difference">
                            <h2 className="font-serif text-[10vw] leading-[0.85] text-white">
                                Tagore's <br /> <span className="italic font-light">World</span>
                            </h2>
                        </div>

                        {/* Description */}
                        <div className="absolute bottom-20 left-20 max-w-sm z-30" data-anim="fade-up">
                            <p className="font-sans text-sm text-gray-300 leading-relaxed text-justify">
                                A highly interactive digital exhibition featuring custom scroll-sensitive cinematic transitions into a structured literary knowledge hub.
                            </p>
                            <div className="mt-4 flex items-center gap-4" data-anim="scale-in">
                                <span className="text-xs border border-white/20 px-2 py-1 rounded-full text-white/60">HTML/CSS</span>
                                <span className="text-xs border border-white/20 px-2 py-1 rounded-full text-white/60">JAVASCRIPT</span>
                                <span className="text-xs border border-white/20 px-2 py-1 rounded-full text-white/60">GSAP</span>
                                <a
                                    href="https://github.com/swoyamsiddhi/englishpbl"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="ml-auto group"
                                    aria-label="View on GitHub"
                                ...
                                <a
                                    href="https://swoyamsiddhi.github.io/englishpbl/"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="group"
